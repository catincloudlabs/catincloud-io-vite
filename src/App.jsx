...
function App() {
  ...
  // UPDATED: Styled for Left Side (Subject)
  const renderTickerSelector = () => (
    <div className="relative group inline-flex items-center ml-3">
        <span className="text-gray-500 mr-2 text-[10px] font-medium tracking-wide">FOR</span>
    ...
    <div className="app-container">
      ...
      <main className="bento-grid pt-4">
        ...
        <Suspense fallback={<div className="span-4 h-tall flex items-center justify-center text-muted animate-pulse">Initializing AI Models...</div>}>
            ...
            {/* 3. STRUCTURE: CHAOS MAP (Selector Moved to Title Area) */}
            <div className="span-2 h-standard area-chaos">
               <InspectorCard 
                 // We inject the selector directly into the Title prop
                 title={
                 ...
                 // Right side now ONLY holds the metric
